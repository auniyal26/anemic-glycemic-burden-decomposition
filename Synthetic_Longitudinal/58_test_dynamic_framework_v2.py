...
M53 = SIM_DIR / "57_synthetic_longitudinal_v2_manifest.json"
...
METRIC_FILE = SIM_RESULTS / "58_longitudinal_prediction_metrics_v2.csv"
SPLIT_FILE = SIM_RESULTS / "58_person_split_v2.csv"
MANIFEST_FILE = SIM_DIR / "58_longitudinal_framework_v2_manifest.json"
...
if obs_sha != m53["observed_sha256"]:
    raise RuntimeError("Observed trajectory SHA256 does not match Script 57 manifest.")
...
manifest = {
    "script": "58_test_dynamic_framework_v2.py",
