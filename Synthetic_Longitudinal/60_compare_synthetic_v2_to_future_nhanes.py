...
SIM_FILE = SIM_DIR / "57_synthetic_longitudinal_observed_v2.parquet"
SIM_MANIFEST = SIM_DIR / "57_synthetic_longitudinal_v2_manifest.json"
A_PARAM = PARAMETERS / "46_outcome_independent_A_transform.json"
G_PARAM = PARAMETERS / "46_outcome_independent_G3_transform.json"

OUT_DETAIL = SIM_RESULTS / "60_realism_by_cycle_v2.csv"
OUT_SUMMARY = SIM_RESULTS / "60_realism_summary_v2.csv"
OUT_FLOW = SIM_RESULTS / "60_realism_actual_flow_v2.csv"
OUT_MANIFEST = SIM_DIR / "60_realism_check_v2_manifest.json"
...
if sim_sha != m53["observed_sha256"]:
    raise RuntimeError("Synthetic observed SHA256 does not match Script 57 manifest.")
...
manifest = {
    "script": "60_compare_synthetic_v2_to_future_nhanes.py",
