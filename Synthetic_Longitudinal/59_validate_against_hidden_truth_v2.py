...
M53_FILE = SIM_DIR / "57_synthetic_longitudinal_v2_manifest.json"
PRED_FILE = SIM_DIR / "58_frozen_longitudinal_predictions_v2.parquet"
M54_FILE = SIM_DIR / "58_longitudinal_framework_v2_manifest.json"
A_PARAM = PARAMETERS / "46_outcome_independent_A_transform.json"
G_PARAM = PARAMETERS / "46_outcome_independent_G3_transform.json"

OUT_PRED = SIM_RESULTS / "59_truth_prediction_metrics_v2.csv"
OUT_DELTA = SIM_RESULTS / "59_model_increment_diagnostics_v2.csv"
OUT_REP = SIM_RESULTS / "59_representation_truth_recovery_v2.csv"
OUT_MANIFEST = SIM_DIR / "59_truth_validation_v2_manifest.json"

print()
print("SYNTHETIC LONGITUDINAL — HIDDEN TRUTH VALIDATION")
print("================================================")
print("Predictions were frozen in Script 58 before hidden truth is opened here.")
print()
...
manifest = {
    "script": "59_validate_against_hidden_truth_v2.py",
