...
print()
print("FORMAL INCREMENTAL-INFORMATION TEST")
print("===================================")
...
r_path = AUDIT / "27_incremental_information_test.R"
...
res = pd.read_csv(RESULTS / "27_incremental_information_tests.csv")

print("SAVED")
print("-----")
print("Results/27_incremental_information_tests.csv")
